...
namespace FirmDAL
{
			class Program
			{
						static void Main(string[] args)
						{
									...
									DBCommander.CreateService(user.uid, 1, "svc1", "description1");
									...
									DBCommander.CreateService(user2.uid, 1, "svc2", "description2");
									...
									DBCommander.CreateService(user3.uid, 1, "svc3", "description3");
									...
									DBCommander.CreateService(user4.uid, 1, "svc4", "description4");
									...
									DBCommander.CreateService(user5.uid, 1, "svc5", "description5");
									...
									DBCommander.CreateService(user6.uid, 1, "svc6", "description6");
